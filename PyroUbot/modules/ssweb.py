...
async def screenshot_handler(client, message):
    ...
    await message.reply_text("<b><i>PROSES SS PAKAI PC King ♛</i></b>")
    ...
    await client.send_photo(message.chat.id, filepath, caption="**__Nih King Gambarnya Sudah Di Screenshot Pakai Pc.__**")
    os.remove(filepath)
