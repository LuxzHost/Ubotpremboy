...
async def done_command(client, message):
    ...
    try:
        ...
        response = (
            ...
            f" <blockquote><b> ᴛᴇʀɪᴍᴀᴋᴀsɪʜ ᴛᴇʟᴀʜ ᴏʀᴅᴇʀ ᴅɪ <a href=tg://openmessage?user_id={OWNER_ID}>KING ZERO ✮</a></blockquote"
            f" <blockquote>ᴛᴇsᴛɪᴍᴏɴɪ : <a href=https://t.me/primezerossz>ᴄʟɪᴄᴋ</a> </blockquote>"
        )
        await izzy_ganteng.edit(response)
