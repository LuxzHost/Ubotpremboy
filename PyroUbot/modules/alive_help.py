...
<blockquote>{bot.me.mention}
    status: {status} 
       {psr} expired_on: {exp} 
        ...
        <blockquote><b>USERBOT 10K/BULAN BY @kingpremzero_ubot</b></blockquote>
"""
