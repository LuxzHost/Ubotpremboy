...
class BTN:
    ...
    def PROMODEK(message):
        button = [
            [InlineKeyboardButton("「 ✅ Setuju & Lanjutkan 」", url="http://t.me/zerossz?text=Bang+Mau+Beli+Reseller+Ubot+Kirim+Qris+Atau+Dana")],
        ]
        return button

    def ALWAYSBOYSZ(message):
        button = [
            [InlineKeyboardButton("room public", url="https://t.me/grupxjunznaire")],
        ]
        return button
    ...
    def START(message):
        if not message.from_user.id == OWNER_ID:
            button = [
                ...
                [
                    InlineKeyboardButton("✭ ʀᴏᴏᴍ ᴘᴜʙʟɪᴄ ✭", url="https://t.me/roomzerossz")
                ],
                [
